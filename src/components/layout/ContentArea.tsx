...
const ContentArea: React.FC<ContentAreaProps> = () => {
  ...
  return (
    <main
      className="absolute top-[64px] left-[56px] w-[1314px] h-[1288px] opacity-100 overflow-y-auto"
      style={{
        background: '#FEFEFE',
        boxShadow: '0px 4px 29.1px 0px #0000000A inset'
      }}
    >
      <div className="p-6 shadow-[inset 0px 4px 29.1px 0px rgba(0,0,0,0.039)] rounded-lg">
        ...
        {/* Summary Cards */}
        <div className=" bg-white grid grid-cols-[repeat(auto-fit,minmax(159px,1fr))] gap-6">
          {summaryKPIs.map((kpi) => (
